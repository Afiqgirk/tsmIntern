...
<div id="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content1">
      ...
      <a class="active" href="statprintm.php">Printer</a>
...
$query = "SELECT printnamem, SUM(printvaluem) AS totalprintm FROM selenggara GROUP BY printnamem";
...
?>
  ...
  <script src="js/chart3.js"></script>
    ...
    <script type="text/javascript">
      ...
      function drawChart() 
	  {
        var data = google.visualization.arrayToDataTable([
				...
				{
					echo "['".$row["printnamem"]."',".$row["totalprintm"]."],";
				}
				?>
        ]);
    ...
    <h2 style="text-align:center; background-color:darkblue; width:90%; color:white; margin-left:66px;"><b>Percentage/Total of <font color="yellow">Printer</font><br>Maintenance Contract</b></h2><br><br>
...
if (mysqli_num_rows($result) > 0){
	...
	?>
     ...
     <table id="customers">
        ...
        <tr>
            <td style="background-color:white; color:black;"><?php echo $printnamem; ?></td>
            <td style="background-color:white; color:black;"><?php echo $printvaluem; ?></td>
        </tr>
    </table>
<?php
         }
