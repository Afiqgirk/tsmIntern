...
<div id="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown1">
    <button class="active" href="statpcm.php" id="dropbtn1">Maintenance Statistic 
      <i class="down"></i>
    </button>
    <div class="dropdown-content1">
      <a class="active" href="statpcm.php">PC</a>
...
$query = "SELECT pcnamem, SUM(pcvaluem) AS totalpcm FROM selenggara GROUP BY pcnamem";
...
?>
  ...
  <script src="js/chart3.js"></script>
    ...
    <h2 style="text-align:center; background-color:darkblue; width:90%; color:white; margin-left:66px;">Percentage/Total of <font color="yellow">PC</font></h2><br><br>
...
<?php
    ...
    $query="SELECT * FROM senaraikontrak,selenggara GROUP BY pcname,pcnamem";
...
if (mysqli_num_rows($result) > 0){
	...
	?>
     ...
     <table id="customers">
        ...
        <tr>
            <td style="background-color:white; color:black;"><?php echo $pc; ?></td>
            <td style="background-color:white; color:black;"><?php echo $sum; ?></td>
        </tr>
    </table>
<?php
         }
