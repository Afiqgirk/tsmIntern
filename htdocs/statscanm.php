...
<div id="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content1">
      ...
      <a class="active" href="statscanm.php">Scanner</a>
...
$query = "SELECT scanamem, SUM(scavaluem) AS totalscam FROM selenggara GROUP BY scanamem";
...
?>
  ...
  <script src="js/chart3.js"></script>
    ...
    <script type="text/javascript">
      ...
      function drawChart() 
	  {
        var data = google.visualization.arrayToDataTable([
				...
				{
					echo "['".$row["scanamem"]."',".$row["totalscam"]."],";
				}
				?>
        ]);
    ...
    <h2 style="text-align:center; background-color:darkblue; width:90%; color:white; margin-left:66px;"><b>Percentage/Total of <font color="yellow">Scanner</font><br>Maintenance Contract</b></h2><br><br>
...
if (mysqli_num_rows($result) > 0){
	...
	?>
     ...
     <table id="customers">
        ...
        <tr>
            <td style="background-color:white; color:black;"><?php echo $scanamem; ?></td>
            <td style="background-color:white; color:black;"><?php echo $scavaluem; ?></td>
        </tr>
    </table>
<?php
         }
