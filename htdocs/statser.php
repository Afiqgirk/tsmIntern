...
<div id="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a class="active" href="statser.php">Server</a>
    </div>
  </div>
    <div class="dropdown1">
...
$query = "SELECT sername, SUM(servalue) AS totalser FROM senaraikontrak GROUP BY sername";
...
?>
  ...
  <script src="js/chart3.js"></script>
    ...
    <h2 style="text-align:center; background-color:darkblue; width:90%; color:white; margin-left:66px;"><b>Percentage/Total of <font color="yellow">Server</font><br>Debriefing Contract</b></h2><br><br>
...
if (mysqli_num_rows($result) > 0){
	...
	?>
     ...
     <table id="customers">
        ...
        <tr>
            <td style="background-color:white; color:black;"><?php echo $sername; ?></td>
            <td style="background-color:white; color:black;"><?php echo $servalue; ?></td>
        </tr>
    </table>
<?php
         }
