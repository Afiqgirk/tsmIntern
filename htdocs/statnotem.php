...
<div id="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content1">
      ...
      <a class="active" href="statnotem.php">Notebook</a>
...
$query = "SELECT notenamem, SUM(notevaluem) AS totalnotem FROM selenggara GROUP BY notenamem";
...
?>
  ...
  <script src="js/chart3.js"></script>
    ...
    <script type="text/javascript">
      ...
      function drawChart() 
	  {
        var data = google.visualization.arrayToDataTable([
				...
				{
					echo "['".$row["notenamem"]."',".$row["totalnotem"]."],";
				}
				?>
        ]);
    ...
    <h2 style="text-align:center; background-color:darkblue; width:90%; color:white; margin-left:66px;"><b>Percentage/Total of <font color="yellow">Notebook</font><br>Maintenance Contract</b></h2><br><br>
...
if (mysqli_num_rows($result) > 0){
	...
	?>
     ...
     <table id="customers">
        ...
        <tr>
            <td style="background-color:white; color:black;"><?php echo $notenamem; ?></td>
            <td style="background-color:white; color:black;"><?php echo $notevaluem; ?></td>
        </tr>
    </table>
<?php
         }
