...
?>
  ...
  <script src="js/chart3.js"></script>
    ...
    <h2 style="text-align:center; background-color:darkblue; width:90%; color:white; margin-left:66px;"><b>Percentage/Total of <font color="yellow">PC</font><br>Maintenance Contract</b></h2><br><br>
...
if (mysqli_num_rows($result) > 0){
	...
	?>
     ...
     <table id="customers">
        ...
        <tr>
            <td style="background-color:white; color:black;"><?php echo $pcnamem; ?></td>
            <td style="background-color:white; color:black;"><?php echo $pcvaluem; ?></td>
        </tr>
    </table>
<?php
         }
