...
<div id="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content1">
      ...
      <a class="active" href="statprom.php">Projector</a>
...
$query = "SELECT pronamem, SUM(provaluem) AS totalprom FROM selenggara GROUP BY pronamem";
...
?>
  ...
  <script src="js/chart3.js"></script>
    ...
    <script type="text/javascript">
      ...
      function drawChart() 
	  {
        var data = google.visualization.arrayToDataTable([
				...
				{
					echo "['".$row["pronamem"]."',".$row["totalprom"]."],";
				}
				?>
        ]);
    ...
    <h2 style="text-align:center; background-color:darkblue; width:90%; color:white; margin-left:66px;"><b>Percentage/Total of <font color="yellow">Projector</font><br>Maintenance Contract</b></h2><br><br>
...
if (mysqli_num_rows($result) > 0){
	...
	?>
     ...
     <table id="customers">
        ...
        <tr>
            <td style="background-color:white; color:black;"><?php echo $pronamem; ?></td>
            <td style="background-color:white; color:black;"><?php echo $provaluem; ?></td>
        </tr>
    </table>
<?php
         }
