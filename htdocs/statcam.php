...
<div id="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a class="active" href="statcam.php">Camera</a>
...
$query = "SELECT camname, SUM(camvalue) AS totalcam FROM senaraikontrak GROUP BY camname";
...
?>
  ...
  <script src="js/chart3.js"></script>
    ...
    <h2 style="text-align:center; background-color:darkblue; width:90%; color:white; margin-left:66px;"><b>Percentage/Total of <font color="yellow">Camera</font><br>Debriefing Contract</b></h2><br><br>
...
if (mysqli_num_rows($result) > 0){
	...
	?>
     ...
     <table id="customers">
        ...
        <tr>
            <td style="background-color:white; color:black;"><?php echo $camname; ?></td>
            <td style="background-color:white; color:black;"><?php echo $camvalue; ?></td>
        </tr>
    </table>
<?php
         }
