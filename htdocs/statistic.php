...
<div id="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a class="active" href="statistic.php">PC</a>
    ...
    <div class="dropdown1">
    <button href="statpcm.php" id="dropbtn1">Maintenance Statistic 
      <i class="down"></i>
    </button>
...
$query = "SELECT pcname, SUM(pcvalue) AS totalpc FROM senaraikontrak GROUP BY pcname";
...
?>
  ...
  <script src="js/chart3.js"></script>
    ...
    <h2 style="text-align:center; background-color:darkblue; width:90%; color:white; margin-left:66px;"><b>Percentage/Total of <font color="yellow">PC</font><br>Debriefing Contract</b></h2><br><br>
...
if (mysqli_num_rows($result) > 0){
	...
	?>
     ...
     <table id="customers">
        ...
        <tr>
            <td style="background-color:white; color:black;"><?php echo $pcname; ?></td>
            <td style="background-color:white; color:black;"><?php echo $pcvalue; ?></td>
        </tr>
    </table>
<?php
         }
