...
<div id="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content1">
      ...
      <a class="active" href="statcamm.php">Camera</a>
...
$query = "SELECT camnamem, SUM(camvaluem) AS totalcamm FROM selenggara GROUP BY camnamem";
...
?>
  ...
  <script src="js/chart3.js"></script>
    ...
    <script type="text/javascript">
      ...
      function drawChart() 
	  {
        var data = google.visualization.arrayToDataTable([
				...
				{
					echo "['".$row["camnamem"]."',".$row["totalcamm"]."],";
				}
				?>
        ]);
    ...
    <h2 style="text-align:center; background-color:darkblue; width:90%; color:white; margin-left:66px;"><b>Percentage/Total of <font color="yellow">Camera</font><br>Maintenance Contract</b></h2><br><br>
...
if (mysqli_num_rows($result) > 0){
	...
	?>
     ...
     <table id="customers">
        ...
        <tr>
            <td style="background-color:white; color:black;"><?php echo $camnamem; ?></td>
            <td style="background-color:white; color:black;"><?php echo $camvaluem; ?></td>
        </tr>
    </table>
<?php
         }
