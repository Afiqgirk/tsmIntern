...
<html>
<title>IPK Pahang-Contract Statistic</title>
<head>    
<style>   
...
<div id="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown1">
    <button class="active" href="statistic.php" id="dropbtn1">Maintenance Statistic 
      <i class="down"></i>
    </button>
    <div class="dropdown-content1">
      ...
      <a class="active" href="statserm.php">Server</a>
    </div>
  </div>
...
$query = "SELECT sernamem, SUM(servaluem) AS totalserm FROM selenggara GROUP BY sernamem";
...
?>
  ...
  <script src="js/chart3.js"></script>
    ...
    <script type="text/javascript">
      ...
      function drawChart() 
	  {
        var data = google.visualization.arrayToDataTable([
				...
				{
					echo "['".$row["sernamem"]."',".$row["totalserm"]."],";
				}
				?>
        ]);
    ...
    <h2 style="text-align:center; background-color:darkblue; width:90%; color:white; margin-left:66px;"><b>Percentage/Total of <font color="yellow">Server</font><br>Maintenance Contract</b></h2><br><br>
...
if (mysqli_num_rows($result) > 0){
	...
	?>
     ...
     <table id="customers">
        ...
        <tr>
            <td style="background-color:white; color:black;"><?php echo $sernamem; ?></td>
            <td style="background-color:white; color:black;"><?php echo $servaluem; ?></td>
        </tr>
    </table>
<?php
         }
