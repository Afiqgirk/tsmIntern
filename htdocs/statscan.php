...
<div id="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a class="active" href="statscan.php">Scanner</a>
...
$query = "SELECT scaname, SUM(scavalue) AS totalsca FROM senaraikontrak GROUP BY scaname";
...
?>
  ...
  <script src="js/chart3.js"></script>
    ...
    <h2 style="text-align:center; background-color:darkblue; width:90%; color:white; margin-left:66px;"><b>Percentage/Total of <font color="yellow">Scanner</font><br>Debriefing Contract</b></h2><br><br>
...
if (mysqli_num_rows($result) > 0){
	...
	?>
     ...
     <table id="customers">
        ...
        <tr>
            <td style="background-color:white; color:black;"><?php echo $scaname; ?></td>
            <td style="background-color:white; color:black;"><?php echo $scavalue; ?></td>
        </tr>
    </table>
<?php
         }
