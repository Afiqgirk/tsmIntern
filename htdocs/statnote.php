...
<div id="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a class="active" href="statnote.php">Notebook</a>
...
$query = "SELECT notename, SUM(notevalue) AS totalnote FROM senaraikontrak GROUP BY notename";
...
?>
  ...
  <script src="js/chart3.js"></script>
    ...
    <script type="text/javascript">
      ...
      function drawChart() 
	  {
        var data = google.visualization.arrayToDataTable([
				...
				{
					echo "['".$row["notename"]."',".$row["totalnote"]."],";
				}
				?>
        ]);
    ...
    <h2 style="text-align:center; background-color:darkblue; width:90%; color:white; margin-left:66px;"><b>Percentage/Total of <font color="yellow">Notebook</font><br>Debriefing Contract</b></h2><br><br>
...
if (mysqli_num_rows($result) > 0){
	...
	?>
     ...
     <table id="customers">
        ...
        <tr>
            <td style="background-color:white; color:black;"><?php echo $notename; ?></td>
            <td style="background-color:white; color:black;"><?php echo $notevalue; ?></td>
        </tr>
    </table>
<?php
         }
